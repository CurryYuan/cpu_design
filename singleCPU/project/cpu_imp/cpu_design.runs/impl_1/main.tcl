...
set rc [catch {
  ...
  set_property ip_repo_paths d:/vivado/cpu_imp/cpu_design.cache/ip [current_project]
  set_property ip_output_repo d:/vivado/cpu_imp/cpu_design.cache/ip [current_project]
  add_files -quiet D:/vivado/cpu_imp/cpu_design.runs/synth_1/main.dcp
